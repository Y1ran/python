# -*- coding: utf-8 -*-
"""
Created on Sat Jan 20 20:34:50 2018
...
train = pd.read_csv('D:\Downloads' + '\d_train_20180102.csv',encoding='gb18030')

test = pd.read_csv('D:\Downloads' + '\d_test_A_20180102.csv',encoding='gb18030')
